...
class FinancialAgent(BaseAgent):
    ...
    def _get_default_assumptions(
        ...
        stage_defaults = {
            "idea": {"revenue_growth_rate": 0.20, "gross_margin": 0.50, "operating_expense_ratio": 0.80},
        ...
        s = stage_defaults.get(stage, stage_defaults.get("early", {"revenue_growth_rate": 0.25, "gross_margin": 0.55, "operating_expense_ratio": 0.70}))
